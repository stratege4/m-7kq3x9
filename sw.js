const APP = "mallorca-app-v2", TILES = "mallorca-tiles-v2";
...
self.addEventListener("fetch", e => {
  ...
  if(url.hostname.includes("arcgisonline.com") || url.hostname.includes("cartocdn.com") || url.hostname === "upload.wikimedia.org" || url.hostname.includes("gstatic.com")){
